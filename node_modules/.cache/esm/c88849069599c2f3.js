let GenerateUUID;_959‍.x([["Provenance",()=>Provenance],["Events",()=>Events],["State",()=>State],["Behavior",()=>Behavior],["Progeny",()=>Progeny],["Group",()=>Group],["Merge",()=>Merge],["Apply",()=>Apply],["ApplyAll",()=>ApplyAll],["default",()=>_959‍.o]]);_959‍.w("./helper",[["GenerateUUID",["GenerateUUID"],function(v){GenerateUUID=v}]]);//! ------------------------------------------------------------------------------------------------------------------
...
//! ------------------------------------------------------------------------------------------------------------------
    ...
    return Object.assign(target, {
       ...
       function Merge(subject, addon, doMerge = false) {
    if(doMerge) {
    ...
    return Object.assign(subject, addon);
       ...
       function Apply(decorators = [], subject = {}, doMerge = false) {
    if(doMerge) {
